              ...
              <div class="modal-body">
                <form action="/action_page.php">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" placeholder="enter team leader id" id="teamleaderid">
                </div>
                  <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" placeholder="enter employee id" class="form-control" id="employee1">
                </div>
...
<br>
  <div id="outbox">
    <button style="margin-left: 20%;width: 60%;text-align: center;" type="button" class="btn" data-toggle="modal" data-target="#myModal1">Proj tittle1</button>
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    ...
                    <div class="row">
                      ...
                      <br>
                      <div class="row">
                        <div class="col-sm-6" style="background-color:white;">Civil Engineer</div>
                        <div class="col-sm-6" style="background-color:white;">employee3</div>
                      </div>
                      <br>
                      <div class="row">
                        <div class="col-sm-6" style="background-color:white;">Architect</div>
                        <div class="col-sm-6" style="background-color:white;">employee2</div>
                      </div>
                      <br>
                      <div class="row">
                        <div class="col-sm-6" style="background-color:white;">Technical Engineer</div>
    ...
    <button style="margin-left: 20%;width: 60%;text-align: center;" type="button" class="btn" data-toggle="modal" data-target="#myModal1">Proj tittle2</button>
    
    <button style="margin-left: 20%;width: 60%;text-align: center;" type="button" class="btn" data-toggle="modal" data-target="#myModal1">Proj tittle3</button>
    
    <button style="margin-left: 20%;width: 60%;text-align: center;" type="button" class="btn" data-toggle="modal" data-target="#myModal1">Proj tittle4</button>
    </div>
